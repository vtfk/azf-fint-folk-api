...
const repackSkole = (skole, hovedskole) => {
  ...
  return {
    ...
    organisasjonsnummer: skole.organisasjonsnummer.identifikatorverdi,
...
module.exports = { aktivPeriode, skoleElementIsAktiv, repackTermin, repackSkolear, repackNavn, repackAdresselinje, createStruktur, repackSkole, repackMiniSkole, getAge }
