...
const vfkExceptionRules = {
  ...
  nameChainOverride: {
    ...
    /* Temp turn off - utgått gyldighetsperiode
    'O-39003-437': {
...
const tfkExceptionRules = {
  ...
  overrideNextProbableLink: {
    ...
    'O-39006-4193': {
      navn: 'Nome vgs - bygg, anlegg + voksenopplæring',
      nextLink: {
        href: `${url}/administrasjon/organisasjon/organisasjonselement/organisasjonsid/O-39006-419024`,
        navn: 'Nome vgs bygg, anlegg og voksenopplæring'
      }
    },
    'O-39006-4194': {
      navn: 'Nome vgs - Helse og oppvekst + fellesfag',
      nextLink: {
        href: `${url}/administrasjon/organisasjon/organisasjonselement/organisasjonsid/O-39006-419023`,
        navn: 'Nome vgs helse og oppvekst og fellesfag'
      }
    },
    'O-39006-4195': {
      navn: 'Nome vgs - Elektro, FBIE og TEK',
      nextLink: {
  ...
  nameChainOverride: {
    ...
    'O-39006-4193': {
      navn: 'Nome vgs - bygg, anlegg + voksenopplæring',
      allowedNameChain: [
        'Nome vgs - bygg, anlegg + voksenopplæring',
        'Nome vgs bygg, anlegg og voksenopplæring'
      ]
    },
    'O-39006-4194': {
      navn: 'Nome vgs - Helse og oppvekst + fellesfag',
      allowedNameChain: [
        'Nome vgs - Helse og oppvekst + fellesfag',
        'Nome vgs helse og oppvekst og fellesfag'
      ]
    },
    'O-39006-4195': {
      navn: 'Nome vgs - Elektro, FBIE og TEK',
      allowedNameChain: [
        'Nome vgs - Elektro, FBIE og TEK',
        'Nome vgs elektro, FBIE og TEK'
      ]
    },
    'O-39006-4199': {
