...
const fintSchool = async (schoolNumber, includeStudentSsn, context) => {
  logger('info', ['fintSchool', 'Creating graph payload', 'schoolNumber', schoolNumber, 'includeStudentSsn', includeStudentSsn], context)
  const payload = graphQlSchool(schoolNumber, includeStudentSsn)
  logger('info', ['fintSchool', 'Created graph payload, sending request to FINT', 'schoolNumber', schoolNumber, 'includeStudentSsn', includeStudentSsn], context)
  ...
  logger('info', ['fintSchool', 'Repacked result - returning', 'schoolNumber', schoolNumber, 'includeStudentSsn', includeStudentSsn], context)
